...
filePath1 = open(
    "Python2/Pt7_FilesDictsCodeBase/1_FileHandling/myfile.txt", "w"
...
filePath1 = open(
    "Python2/Pt7_FilesDictsCodeBase/1_FileHandling/yourName.txt", "w"
)  # folder/folder/filename
filePath1.write("My Name is Melvin")  # write to file
filePath1.close()  # close the filepath and file/ releasing the resource
